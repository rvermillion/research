...
Principled attention also introduces a ground state $v_0$ with relevance threshold $\gamma_i$ and a margin amplification factor $\alpha_i$ to counteract long contexts. For full details, see Vermillion (2026).
